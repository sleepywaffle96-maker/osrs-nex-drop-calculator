...
public class NexCalculatorPanel extends PluginPanel
{
    ...
    public void updateDisplayWithLiveDamage(int currentKills, int sessionKills, int liveDamagePercent)
    {
        ...
        for (int i = 1; i <= currentKills; i++)
        {
            ...
            double killDropChance = currentBaseChance * damageFraction * 100.0;
        ...
        expectedPanel.revalidate(); expectedPanel.repaint();
        receivedPanel.revalidate(); receivedPanel.repaint();
    ...
    private class DropRowPanel extends JPanel
    {
        ...
        {
            try { return ImageUtil.loadImageResource(NexCalculatorPanel.class, path); }
            catch (Exception e) { return new BufferedImage(18, 18, BufferedImage.TYPE_INT_ARGB); }
        }
